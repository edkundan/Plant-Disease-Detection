...
* **Well-Commented:** Extensive comments are provided throughout the notebook, explaining the purpose of each section, complex logic, and key design decisions. Comments also explicitly link code sections to the project's rubric requirements.
